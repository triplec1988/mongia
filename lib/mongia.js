...
Mongia.prototype.findOrCreateCollection = function(collectionName, options, callback) {
    var self = this;
    self.collection(collectionName, options, function(err, collection){
        if (collection === null) {
            self.newCollection(collectionName, options, function(err, collection){
                callback(err, collection);
            });
        } else {
            callback(err, collection);
